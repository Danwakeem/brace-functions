...
# Deploy
wsk action update CompileCode CompileCode/index.js --kind nodejs:8 -t 300000

wsk action update GetLanguages GetLanguages/index.js --kind nodejs:8 -t 300000

wsk action update GetOutputV2 GetOutputV2/index.js --kind nodejs:8 -t 300000